    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('price', TextType::class, [
                ...
                'required' => false,
                'label' => t('Price :'),
                'attr' => ['class' => 'touchspin-decimal recipe-date-subscription-price', 'data-min' => '0', 'data-max' => '100000000'],
            ])
            ->add('promotionalPrice', TextType::class, [
                ...
                'attr' => ['class' => 'touchspin-decimal recipe-date-subscription-promotionalprice', 'data-min' => '0', 'data-max' => '100000000'],
            ])
            ->add('seatingPlanSections', ChoiceType::class, [
                ...
                'help' => '<ul class="list-unstyled"><li>Press CTRL to select multiple sections, press SHIFT to select all sections</li><li>A section can only be assigned to one subscription in an recipe date</li></ul>',
                'help_html' => true,
                'attr' => ['class' => 'recipe-date-subscription-seating-plan-sections '],
            ])
            ->add('quantity', TextType::class, [
                'purify_html' => true,
                'required' => true,
                'label' => t('Quantity :'),
                'attr' => ['class' => 'touchspin-integer recipe-date-subscription-quantity', 'data-min' => '1', 'data-max' => '1000000'],
            ])
