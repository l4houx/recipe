...
class Testimonial
{
    ...
    #[Vich\UploadableField(mapping: 'photo_testimonial', fileNameProperty: 'photoName')]
    #[Assert\File(
        maxSize: '2M',
    ...
    */
     ...
     */
    /*
    public function setPhotoFile(File|UploadedFile|null $photoFile): static
    {
    ...
    {
        return '/images/testimonial/'.$this->photoName;
    }

    public function getPhotoPlaceholder(string $size = 'default'): string
    {
        if ('small' === $size) {
