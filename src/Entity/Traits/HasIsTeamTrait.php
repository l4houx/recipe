...
trait HasIsTeamTrait
{
    ...
    #[Vich\UploadableField(mapping: 'user_team', fileNameProperty: 'teamName')]
    #[Assert\File(
        maxSize: '2M',
        mimeTypes: ['image/jpeg', 'image/jpg', 'image/gif', 'image/png'],
        mimeTypesMessage: 'The file should be an image'
    )]
    private ?File $teamFile = null;
     ...
     */
    public function setTeamFile(File|UploadedFile|null $teamFile): static
    {
    ...
    public function getTeamFile(): ?File
    {
    ...
    public function getTeamPath(): string
    {
        return 'uploads/user/team/'.$this->teamName;
    }

    public function getTeamPlaceholder(string $size = 'default'): string
    {
        if ($size == "small") {
